...
db.prepare("CREATE TABLE IF NOT EXISTS status (channelID TEXT NOT NULL, messageID TEXT, guildID TEXT, serverID TEXT)").run();
db.prepare("CREATE TABLE IF NOT EXISTS chat (channelID TEXT NOT NULL, serverID TEXT)").run();
